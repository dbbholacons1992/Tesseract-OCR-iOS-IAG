Pod::Spec.new do |s|
  ...
  s.name                    = 'TesseractOCRiOSIAG'
  s.version                 = '4.0.1'

  s.summary                 = 'Use Tesseract OCR in iOS projects written in either Objective-C or Swift.'

  s.homepage                = 'https://github.com/vueling/Tesseract-OCR-iOS-IAG'
  s.documentation_url       = 'https://github.com/vueling/Tesseract-OCR-iOS-IAG/blob/master/README.md'
  ...
  s.source                  = { :git => 'https://github.com/vueling/Tesseract-OCR-iOS-IAG.git',                                                         :tag => s.version.to_s }
